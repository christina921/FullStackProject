...
$(document).ready(() => {
  ...
  signupBtn.addEventListener("click", () => {
    ...
    if (usernameElement.value == "" || passwordElement.value == "" || phoneElement.value == "" || fullName.value == "") {
      ...
      const alertTextElement = document.getElementById("alert-text");
      alertTextElement.innerText = "Please tap on map to show us where you are";
      return;
    }
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response == "already user") {
          alertTextElement.innerText = "There is already a user with that username.";
          return;
        }
        ...
        alertTextElement.innerText = "Signup was successful. Please login to proceed.";
      },
    });
  });
